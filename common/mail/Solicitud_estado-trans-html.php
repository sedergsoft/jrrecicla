                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:28px;line-height:120%;text-align:center;mso-line-height-alt:33.6px;">
                                                                    <p style="margin: 0; word-break: break-word;"><span><strong><span> <p>Hola <?= $solicitud->cliente->instalacion ?> ,</span></strong></span><br><span>Buenas, Sr(a) <?=$solicitud->cliente->representante?></span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    ...
                                                                    <div class style="font-size: 12px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">La fecha probable de recojida es :<?=$recogida->fecha_recogida?>.</p>
                                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">El Transportista se identificara como :(<?=$recogida->transportista->chofer?>)</p>
                                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;"> El vehiculo esta identificado con la matricula (<?=$recogida->transportista->vehiculo?>)  </p>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;">
                                                                <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:14px;line-height:150%;text-align:center;mso-line-height-alt:21px;">
                                                                    <p style="margin: 0; word-break: break-word;">Para más detalles, consulte su solicitud en el sistema.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
